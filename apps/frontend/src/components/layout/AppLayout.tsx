  ...
  return (
    ...
    >
      ...
      <div className="flex-1 min-h-0 flex flex-col">
        <header className="flex items-center justify-between px-6 md:px-10 py-3 md:py-5 border-b border-white/6 shrink-0">
          <div>
        ...
        <main className="flex-1 min-h-0 overflow-y-auto overflow-x-hidden px-5 md:px-8 pt-5 pb-24 md:pb-8 flex flex-col gap-8">
          {children}
        </main>
      </div>
